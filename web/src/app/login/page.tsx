...
/** Login — E6 UI 목업. ※실제 인증/본인인증 미연동(대표·법무 게이트). */
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-surface-container-high p-4">
      <div className="flex w-full max-w-sm flex-col gap-4 rounded-xl bg-surface p-6 shadow-2">
        ...
        <Button size="lg" className="w-full">로그인</Button>
        ...
        <div className="flex flex-col gap-2">
          <Button variant="outline" className="w-full">카카오로 계속</Button>
          <Button variant="outline" className="w-full">Google로 계속</Button>
        </div>
